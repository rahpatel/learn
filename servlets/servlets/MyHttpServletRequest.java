...
public class MyHttpServletRequest implements HttpServletRequest {
	...
	public HttpSession getSession(boolean arg0) {
		...
		if(arg0){
			   if(!hasSession()){
				        System.out.println("u should come here");
				        String sessionId = getNewId();	
				        System.out.println("u should come here 1");
					    m_session = new MyHttpSession(sessionId);
					    m_response.setUpSession(m_session);
					    System.out.println("u should come here2");
					       
					    WebServer.sessions.put(sessionId, m_session);
					    System.out.println("u should come here3");
					       
					    Cookie cookie = new Cookie("SessionId",sessionId);
					    cookie.setMaxAge(60*60);
					    System.out.println("u should come here4");
					       
					    this.m_response.addCookie(cookie);
					    System.out.println("u should come here5");
				        return m_session;	             
			   }
		       }
		...
		m_session = WebServer.sessions.get(getSessionIdFromCookie());
		 m_response.setUpSession(m_session);
	...
	public String getNewId(){
		return  Integer.toString(WebServer.sidgen.getNextId());
	...
	public void setSession(){
		if(sessionIdCookieExists()){
           String sessionid  = getSessionIdFromCookie();
            m_session = WebServer.sessions.get(sessionid);
            m_response.setUpSession(m_session);
